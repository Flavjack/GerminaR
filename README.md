...
<div style="display:inline-block; width:100%"><p style="text-align:center"><a target="_blank" href="https://cran.r-project.org/web/packages/GerminaR/index.html"><img src="https://raw.githubusercontent.com/Flavjack/GerminaR/master/inst/GerminaQuant/www/favicon/android-chrome-256x256.png" style="height:80px" title="GerminaQuant" alt="GerminaQuant for R"></a></p></div>
