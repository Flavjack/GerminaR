...
<!-- badges: start -->
[![CRAN status](https://img.shields.io/cran/v/GerminaR.svg)](https://CRAN.R-project.org/package=GerminaR)
...
```
After install the package and the app dependencies you can access to the app through the Addins list in Rstudio, or in the following link in the internet <https://inkaverse.shinyapps.io/germinaquant/>
