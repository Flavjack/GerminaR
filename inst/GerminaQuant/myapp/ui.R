...
tabPanel("osmotic tools", icon = icon("wrench", lib = "glyphicon"),
        ...
        tabsetPanel(type = "tabs", 
                    ...
                    tabPanel("SALT",
                             ...
                             numericInput("dis", label = p("dissociation"), value = 1.8, min = 0)
           ...
           mainPanel( 
             ...
             p("The osmotic potencial for a salt, can be measured directly with an osmometer, or it can be calculated from the solute concentration from the van't Hoff relation:  
             \\(\\psi_s = -RTC_i\\); where \\(R\\) is the gas constant (i.e. \\(0.0083 L/atm/mol/K\\)), \\(T\\) is the absolute temperature in degrees in Kelvin (\\(273.15^{o}C\\)), 
             \\(C\\) is the solute concentration in \\(mol*L^{-1}\\), and \\(i\\) is the dissociation constant of the salt. (i.e. \\(NaCl = 1.8, KCl = 1.8, CaCl_2 = 2.4, sacarose = 1\\)). 
              The unit for \\(\\psi_s\\) is \\(Mpa\\)."),
             
             p("For \\(PEG 6000\\), the osmotic potentials can be calculated as described by Michel and Kaufmann (1973): \\(\\psi_s = -(1.18*10^{-2})C - (1.18*10^{-4})C^2 + (2.67*10^{-4})CT + (8.39*10^{-7})C^2T\\); 
             where \\(C\\) is the concentration of \\(PEG 6000\\) in \\(g*L^{-1}\\) and \\(T\\) is the temperature in degrees \\(^{o}C\\).  The unit for \\(\\psi_s\\) is \\(bar\\)."),
...
tabPanel("about", icon = icon("info-sign", lib = "glyphicon"),
         ...
         h4(strong("Authors")),
                ...
                p(strong("Marcelo F. Pompelli "), "(",a("mfpompelli@gmail.com"), "). Department of Biology, Federal University of Pernambuco, Recife, Brazil"),
