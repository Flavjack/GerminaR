...
var <- data.frame(
  ...
  "variables" = c("germinated seed number", "germination", "germination asin", "mean germination time", "germination speed", "germination rate", "germination synchrony", "germination uncertany", "germination standard deviation", "germination variance", "coef. variance of germinaton"),
...
# GermBook ----------------------------------------------------------------
 ...
 output$usmn <- renderUI({
   gb <- tags$iframe(src = "https://bookdown.org/flavjack/germinaquant/", style="height:500px; width:100%; scrolling=yes")
   print(gb)
   gb
 })
 ...
 output$dtsm <- renderUI({
   gb <- tags$iframe(src = "https://docs.google.com/spreadsheets/d/1QziIXGOwb8cl3GaARJq6Ez6aU7vND_UHKJnFcAKx0VI/edit?usp=sharing", style="height:500px; width:100%; scrolling=yes")
   print(gb)
   gb
 }) 
